...
# 企業創新治理工具箱（Corporate Innovation Management Playbook）
...
- 延伸：Asgard `ux-lean-startup`（新創方法）、`grad-disruptive-innovation`（破壞式創新）、`grad-ambidexterity`（雙元能力）、`biz-lean-six-sigma`、`grad-innovation-diffusion-bass`；本 repo `ops-digital-transformation`（規劃中）
