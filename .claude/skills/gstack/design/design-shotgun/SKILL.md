...
description: 'Design shotgun: generate multiple AI design variants, open a comparison
  board, collect structured feedback, and iterate. Standalone design exploration you
  can run anytime. Use when: "explore designs", "show me options", "design variants",
  "visual brainstorm", or "I don''t like how this looks". Proactively suggest when
  the user describes a UI feature but hasn''t seen what it could look like. (gstack)'
---
