...
description: "Systematically triage failing tests by grouping errors, fixing root causes in priority order, and verifying incrementally. Use when CI fails, test suite is broken, or multiple tests fail after a refactor or merge."
