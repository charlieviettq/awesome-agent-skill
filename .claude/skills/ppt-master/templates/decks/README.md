...
Full data model: [`docs/zh/templates-architecture.md`](../../references/upstream-docs/templates-architecture.md).
...
- [`docs/zh/templates-architecture.md`](../../references/upstream-docs/templates-architecture.md) — three-class data model + fusion rules
