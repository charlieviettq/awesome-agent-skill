...
name: rag-systems
description: >
  Design retrieval-augmented generation pipelines—chunking, embeddings, retrieval,
  reranking, grounding, and evaluation. Use when building or improving doc Q&A,
  code search agents, or knowledge bases.
  Triggers: "RAG", "vector search", "embeddings", "retrieval", "knowledge base".
---
