...
description: >
  Design agent tools and CLI surfaces—schemas, naming, errors, idempotency, and
  discoverability for LLM callers. Use when defining tools for agents, SDKs,
  or AI-native CLIs.
  Triggers: "tool schema", "agent tool", "function calling", "AI CLI".
---
