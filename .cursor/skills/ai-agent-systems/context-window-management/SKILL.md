...
description: >
  Manage LLM context budgets—prioritization, summarization, compaction, and
  what to load vs reference. Use for long sessions, large repos, or multi-doc tasks.
  Triggers: "context window", "too long", "summarize context", "token budget".
---
