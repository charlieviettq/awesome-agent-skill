...
mutating: false
priority: normal
source: "anthropics/knowledge-work-plugins/product-management"
---
# Stakeholder Update

> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](../CONNECTORS-product-management.md).
