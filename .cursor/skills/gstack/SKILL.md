...
description: Fast headless browser for QA testing and site dogfooding. Navigate pages,
  ...
  test responsive layouts, forms, uploads, dialogs, and capture bug evidence. Use
  when asked to open or test a site, verify a deployment, dogfood a user flow, or
  file a bug with screenshots. (gstack)
---
