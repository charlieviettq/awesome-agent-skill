...
> Architecture rationale (why narrow scope, why no backups, the spec_lock as execution contract): see [docs/technical-design.md "Spec Propagation"](../../references/upstream-docs/technical-design.md#spec-propagation-spec_lockmd-as-execution-contract).
