...
source: "charlieviettq/ppt-master@13a25616e6354fe5abe16f41da18f532e51ac644"
license: MIT
...
The architecture has three independent reference bundles. Full schema in [`docs/zh/templates-architecture.md`](references/upstream-docs/templates-architecture.md). Summary:
