...
- `architecture-decision-records` — record resulting decisions
- `doubt-driven-review` — challenge critical assumptions
- `internal-credit-train-lifecycle` — credit platform context (if available)
