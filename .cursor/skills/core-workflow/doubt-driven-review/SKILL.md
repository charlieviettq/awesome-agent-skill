...
description: >
  Adversarial fresh-context review for non-trivial decisions before they stand.
  Use for production-impacting logic, security-sensitive changes, unfamiliar code,
  or high-blast-radius architecture choices.
  Triggers: "doubt check", "adversarial review", "challenge this decision", "second look".
---
