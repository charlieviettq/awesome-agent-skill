...
mutating: false
priority: normal
source: "anthropics/knowledge-work-plugins/productivity"
---
# Update Command

> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](../CONNECTORS-productivity.md).
